...
$request = "SELECT a.task_content, b.user_email as assigned_email, a.task_status, a.task_creation_date, a.task_deadline_date, c.user_email as creator_email, d.user_email as editor_email, a.task_hourneeded
FROM tasks as a 
